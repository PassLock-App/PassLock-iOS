//
//  HomeSplitViewController+Noti.swift
//  PassLock
//
...
extension HomeSplitViewController {
    func addObserviseNoti() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(didEnterBackgroundNotifi), name: UIApplication.didEnterBackgroundNotification, object: nil)
    ...
    @objc func didEnterBackgroundNotifi() {
