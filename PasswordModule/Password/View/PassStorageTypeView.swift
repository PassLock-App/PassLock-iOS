...
class PassStorageTypeView: UIView {
    ...
    override func layoutSubviews() {
        ...
        let passWidth = itemType.nameStr().width(passFont)
    ...
    var itemType = AppLocalManager.shared.lastItemType == .allItem ? .password : AppLocalManager.shared.lastItemType {
        didSet {
            passTypeLabel.text = itemType.nameStr()
            self.layoutSubviews()
        }
    }
